...
import com.suyigou.dao.TbSellerMapper;
import com.suyigou.pojo.TbSeller;
import com.suyigou.pojo.TbSellerExample;
import com.suyigou.pojo.TbSellerExample.Criteria;
...
public class SellerServiceImpl implements SellerService {
    ...
    public void add(TbSeller seller) {
        seller.setStatus("0");//将状态设置为0，表示未经审核
        seller.setCreateTime(new Date());//添加时间
